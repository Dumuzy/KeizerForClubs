...
#### Réduire le bonus pour absence (non)excusé

Lorsque cette case n'est pas cochée, les mêmes bonus d'absence sont accordés,
quelle que soit la fréquence des absences d'un joueur. Il s'avère que cette politique
encourage trop les absences dans le tournoi. D'un autre côté, nous ne voulons vraiment 
pas pénaliser les joueurs qui sont simplement malades une seule fois. 

Si cette case est cochée, les bonus pour les absences justifiées/non justifiées sont 
divisés par 2 à chaque fois qu'un joueur est absent, que ce soit pour une raison justifiée ou non. 
Ainsi, par exemple, si le bonus de base est fixé à 32 et qu'un joueur est absent 3 fois, il obtient
32 % pour la première absence, 16 % pour la deuxième et 8 % pour la troisième.


#### Réduire la valeur de la place du tour précédent

Lorsque cette case n'est pas cochée, le joueur Xyz obtient les points Keizer que Xyz a gagnés 
en jouant. À cela s'ajoutent les points Keizer qu'une victoire
contre lui-même lui rapporterait. (Rank-Pb dans le tableau croisé.)
Ceci est très utile pour les premiers tours, mais 
semble un peu injuste pour les tours suivants.
(En réalité, cela n'a généralement pas beaucoup d'importance.)

Si cette case est cochée, un facteur est utilisé pour réduire la
valeur de la victoire contre soi-même d'un cinquième  à chaque tour, de sorte qu'à partir du
cinquième tour, elle est nulle.
